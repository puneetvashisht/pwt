...
public class WorkoutActiveController {
	...
	@PostMapping("/ActiveWorkouts/assignWorkout")
	...
	@GetMapping("/ActiveWorkouts/calculateCalories/{id}")
	...
	public ResponseEntity<WorkoutTracker> getWorkoutActiveDetailsById(@PathVariable("id") int id) throws UserNotFoundException {
	...
	@DeleteMapping("/ActiveWorkouts/delete/{id}")
	@ApiOperation(value = "Delete by Id", notes = "Enter your WorkoutActive table Id", response = WorkoutTracker.class)
	public ResponseEntity<String> deleteWorkoutActiveDetailsById(@PathVariable("id") int id) throws UserNotFoundException {
