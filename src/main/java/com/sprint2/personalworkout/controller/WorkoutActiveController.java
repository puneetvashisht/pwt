...
public class WorkoutActiveController {
	...
	public ResponseEntity<String> assignWorkout(@RequestParam("userid") int User_id,
			@RequestParam("workoutid") int workout_id)
			throws UserNotFoundException, UserAlreadyExistsException, WorkoutNotFoundException {
		ResponseEntity<String> re = null;
		WorkoutActiveTracker workout = activeService.assigningWorkout(User_id, workout_id);
		if (workout != null) {
	...
	public ResponseEntity<WorkoutActiveTracker> getWorkoutActiveDetailsById(@PathVariable("id") int id)
		...
		WorkoutActiveTracker userFound = activeService.UserById(id);
		if (userFound != null) {
